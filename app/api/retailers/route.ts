...
export async function POST(req: NextRequest) {
  ...
  // Use retail_pin as the auth password if provided, otherwise use password field
  const authPassword = retail_pin || password;
...
export async function PATCH(req: NextRequest) {
  ...
  // Also update auth password when retail_pin changes (retail_pin = login password)
