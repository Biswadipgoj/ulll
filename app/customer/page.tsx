...
export default function CustomerPortal() {
  ...
  // Broadcast messages
  const [broadcastMessages, setBroadcastMessages] = useState<{ id: string; message: string; image_url?: string | null; expires_at: string }[]>([]);
          ...
          <div key={b.id} className="animate-fade-in relative" style={{ background: 'linear-gradient(135deg, #dbeafe, #eff6ff)', border: '2px solid #93c5fd', borderRadius: '1rem', padding: '1.25rem' }}>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                {b.image_url && (
                  <img src={b.image_url} alt="Broadcast" style={{ marginTop: '0.75rem', maxHeight: '150px', borderRadius: '0.75rem', objectFit: 'cover', border: '1px solid #93c5fd' }} />
                )}
              </div>
            </div>
          </div>
